...
?>
        ...
        <main class="flex-1 p-8">
            <h1 class="text-3xl text-center md:text-5xl font-bold text-purple-700 mb-4">NUMS Prep Hub</h1>
            <p class="text-lg  text-gray-700 mb-4 max-w-xl">
                NUMS Practice Zone is your one-stop platform for comprehensive MDCAT preparation. <br>
                We offer: ✅ Chapter-wise MCQs ✅ Past Papers ✅ Mock Tests
            </p>
